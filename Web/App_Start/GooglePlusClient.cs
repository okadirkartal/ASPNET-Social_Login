...
namespace Web.App_Start
{
    public class GooglePlusClient : OAuth2Client
    {
        ...
        protected override Uri GetServiceLoginUrl(Uri returnUrl)
        {
            ...
            uriBuilder.AppendQueryArgument("redirect_uri", returnUrl.GetLeftPart(UriPartial.Path).Replace("http:", "https:"));
        ...
        protected override string QueryAccessToken(Uri returnUrl, string authorizationCode)
        {
            ...
            values.Add("redirect_uri", returnUrl.GetLeftPart(UriPartial.Path).Replace("http:", "https:"));
